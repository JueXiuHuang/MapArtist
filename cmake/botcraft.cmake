...
ExternalProject_Add(Botcraft
  ...
  CONFIGURE_COMMAND ${CMAKE_COMMAND} -S ${BOTCRAFT_ROOT} -B ${BOTCRAFT_BUILD_PATH} -G ${CMAKE_GENERATOR} -DBOTCRAFT_USE_OPENGL_GUI=ON -DBOTCRAFT_USE_IMGUI=ON -DCMAKE_CXX_FLAGS=${BOTCRAFT_CXX_FLAGS} -DBOTCRAFT_GAME_VERSION=${MC_VERSION} -DBOTCRAFT_OUTPUT_DIR=${BOTCRAFT_BUILD_PATH} -DCMAKE_BUILD_TYPE="Release" -A ${CMAKE_GENERATOR_PLATFORM} -T ${CMAKE_GENERATOR_TOOLSET}
