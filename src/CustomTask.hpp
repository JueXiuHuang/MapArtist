...
#ifndef SRC_CUSTOMTASK_HPP_
#define SRC_CUSTOMTASK_HPP_
...
/// @brief Just like normal SortInventory, but this will place tool at specified
/// position.
/// @param c The client performing the action
...
Botcraft::Status FindPathAndMoveImpl(
    Botcraft::BehaviourClient &c, Botcraft::Position pos,
    pathfinding::goal::GoalBase<pathfinding::Position> &goal);
...
/// details should be displayed in the console
/// @param c The client performing the action
